  ...
  return (
    <header className="flex items-center justify-between p-4 border-b w-full">
      <div className="flex items-center">
        <h1 className="text-xl font-bold">{title || "Monitoring & Troubleshooting Agents"}</h1>
      </div>
      <div className="flex items-center gap-2">
        <Button onClick={() => router.push("/evaluations")} variant="outline" className="gap-2">
          <BarChart3 className="h-4 w-4" />
          Evaluations
        </Button>
        <Button variant="outline" onClick={() => router.push("/devops-agent")}>
          DevOps Agent
        </Button>
